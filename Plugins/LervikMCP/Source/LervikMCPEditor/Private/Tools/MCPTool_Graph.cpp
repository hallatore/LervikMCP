...
FMCPToolInfo FMCPTool_Graph::GetToolInfo() const
{
    ...
    Info.Parameters  = {
        { TEXT("action"),          TEXT("'add_node', 'edit_node', 'connect', 'disconnect', 'add_variable', 'edit_variable', 'add_function', 'add_component', 'edit_component', 'compile', 'help'"), TEXT("string"), true  },
        { TEXT("target"),          TEXT("Blueprint or Material asset path"),                                                      TEXT("string"), true  },
        { TEXT("graph"),           TEXT("[add_node/edit_node/connect] Graph name (BP only, default: EventGraph)"),                TEXT("string"), false },
        ...
        { TEXT("properties"),      TEXT("[edit_node/edit_component] Properties to set via reflection {PropName: Value}"),         TEXT("object"), false },
        { TEXT("pin_defaults"),    TEXT("[edit_node] Pin default values {PinName: Value}"),                                       TEXT("object"), false },
        { TEXT("edits"),           TEXT("[edit_node] Batch: array of edit objects"),                                              TEXT("array"),  false, TEXT("object") },
        { TEXT("source"),          TEXT("[connect/disconnect] {node: GUID, pin: PinName}. Pin names are case-sensitive; use inspect type=pins to discover exact names"), TEXT("object"), false },
        { TEXT("dest"),            TEXT("[connect/disconnect] {node: GUID, pin: PinName} or {property: MaterialProperty}"),       TEXT("object"), false },
        ...
        { TEXT("var_type"),        TEXT("[add_variable/edit_variable] float, int, bool, string, Vector, Rotator, Transform, Object:ClassName"), TEXT("string"), false },
        ...
        { TEXT("inputs"),          TEXT("[add_function] Array of {name, type} input pin descriptors"),                            TEXT("array"),  false, TEXT("object") },
        { TEXT("outputs"),         TEXT("[add_function] Array of {name, type} output pin descriptors"),                          TEXT("array"),  false, TEXT("object") },
        { TEXT("pure"),            TEXT("[add_function] Mark function as pure (no exec pins)"),                                   TEXT("boolean"),false },
